...
\renewcommand*\title{CV Leonardo Pérez 2019}
...
\subsection{Coordinación de proyectos}
  \cvitem{2018-2019}{Desarrollo de un modelo integral para la prevención y atención del sindrome por virus Zika en Venezuela: un enforque desde la salud sexual y reproductiva.}
...
\medskip
    ...
    % \begin{compactdesc}
    %     \item{\em Gustavo Torres — }{\em Fundador y director ejecutivo, Kavanayentech}
    %     \item{\bfseries Email:} \emaillink{gtorres@kavanayentech.com}
    %     \item{\bfseries Teléfono:} +1 786 487 7791
    % \end{compactdesc}
